...
Статус: v1.1.0. Документ описывает реально работающий синтаксис
...
Ограничения v1.1: обобщаются только функции (структуры/enum/impl —
...
(иначе — ошибка `Cannot infer type arguments`).
