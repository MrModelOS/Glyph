...
//!
//! Ported 1:1 from `NeuralScript/include/ns/runtime/ns_runtime.h`.

/// Byte-for-byte copy of `ns_runtime.h`.
pub const NS_RUNTIME_H: &str = r#"#ifndef NS_RUNTIME_H
#define NS_RUNTIME_H
...
pub const NS_RUNTIME_VERSION: &str = "1.2.0";
